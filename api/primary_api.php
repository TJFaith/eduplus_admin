...
// ================================ API FOR  *********  SUBJECTS **********
if($action == 'get_Primary_Subject'){
    $query = json_decode(file_get_contents("php://input"),true);
    return json_encode($controllerQuery->get_Primary_Subject($query));
}

if($action == 'add_Primary_Subject'){
    $query = json_decode(file_get_contents("php://input"),true);
    return json_encode($controllerQuery->add_Primary_Subject($query));
}
// delete_Primary_Subject
if($action == 'delete_Primary_Subject'){
    $query = json_decode(file_get_contents("php://input"),true);
    return json_encode($controllerQuery->delete_Primary_Subject($query));
}

// update_Primary_Subject
if($action == 'update_Primary_Subject'){
    $query = json_decode(file_get_contents("php://input"),true);
    return json_encode($controllerQuery->update_Primary_Subject($query));
}
